...
import ClinicHistoryPortletsContainer from "views/ClinicPortlets/ClinicHistoryPortletsContainer";
    ...
    return (
      <div>
        ...
        >
          ...
          <br />
          <div className={classNames(classes.main, classes.mainRaised)}>
            <ClinicHistoryPortletsContainer />
          </div>
          <br />
          <Footer />
        </div>
...
export default withStyles(componentsStyle)(ClinicHistory);
