...
import AddPatientNoteDialogContent from "views/Dialogs/AddPatientNoteDialogContent";
...
class AddPatientNoteDialog extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      openSnackbar: false,
  ...
  handleDialogSave = () => {
    const message = "Patient note has been saved!";
    ...
    return (
      <div>
        ...
        //   style={{ maxHeight: "500px" }}
          ...
          aria-labelledby="addPatientNoteDialogTitle"
          aria-describedby="addPatientNoteDialogContent"
        >
          <DialogTitle
            id="addPatientNoteDialogTitle"
            disableTypography
          ...
          <DialogContent
            id="addPatientNoteDialogContent"
...
AddPatientNoteDialog.propTypes = {
...
const AddPatientNoteDialogWithCSS = withStyles(componentsStyle)(
