...
import RemindMeDialogContent from "./RemindMeDialogContent";

class RemindMeDialog extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      openSnackbar: false,
    ...
    return (
      <div>
        <Dialog
          ...
          aria-labelledby="remindMeDialogTitle"
          aria-describedby="remindMeDialogContent"
        >
          <DialogTitle
            id="remindMeDialogTitle"
            disableTypography
...
const RemindMeDialogWithCSS = withStyles(componentsStyle)(RemindMeDialog);

export default connect(
  mapStateToProps,
  { toggleSnackbar }
)(RemindMeDialogWithCSS);
