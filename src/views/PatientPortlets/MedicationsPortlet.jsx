        ...
        <GridContainer style={{ textAlign: "right" }}>
          <GridItem xs={12} sm={12} md={9}>
            <Button
              color="primary"
              simple
              onClick={() => this.handleClickOpenTemporaryMedicationModal()}
            >
            ...
            <Dialog
              ...
              keepMounted
              onClose={() => this.handleCloseAddTemporaryMedicationModal()}
            ...
            >
                        ...
                        >
                          <div style={{ textAlign: "left" }}>
                            <small style={{ textAlign: "left" }}>
                              Patient does not use the patient application to
                              track medication information. Contact the patient
                              to discuss medication updates.
                            </small>
                          </div>
                        </FormControl>
                      </div>
              ...
              <DialogActions className={classes.modalFooter}>
                <Button
                  onClick={() => this.handleCloseAddTemporaryMedicationModal()}
                  color="primary"
                >
                  Cancel
                </Button>
